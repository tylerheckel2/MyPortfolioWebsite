...
export default function ProjectsPage(){
  ...
  const experienceRouteChange = () =>{ 
      ...
      <table class="styled-table">
        ...
        <tbody>
          <tr class ="td-typing-area">
            <td class="academic"><a class="project-header"><a href="https://github.com/tylerheckel2/M2M-File-Transfer-System" target="_blank" rel="noopener noreferrer">M2M File Transfer System | Software Engineer | March 2025 - May 2025</a></a><br></br>-Developed a simplified FTP-style client-server system using Python sockets to simulate machine-to-machine (M2M) communication in a controlled network environment.<br></br>-Engineered TCP-based socket communication to enable reliable file uploads, downloads, and session termination between autonomous client and server components.<br></br>-Designed and implemented core M2M principles including connection establishment, command parsing, and file integrity verification, mimicking real-world IoT device interactions.<br></br>-Conducted structured simulations to validate system reliability and ensure consistent performance.
            </td>
            <td class="academic"><a class="project-header"><a href="https://github.com/tylerheckel2/Encryption-Algorithm-Simulation" target="_blank" rel="noopener noreferrer">Encryption Algorithm Simulation  | Software Engineer | Personal Project | November 2024 - December 2024</a></a><br></br>-Developed two interactive Python programs to simulate symmetric (AES) and asymmetric (RSA) encryption using the cryptography library.<br></br>-Implemented AES encryption with Fernet, including key generation, message encryption/decryption, and a user-friendly console interface.<br></br>-Built RSA encryption functionality with key pair generation, secure key storage using PEM files, and message encryption/decryption using OAEP padding and SHA-256 hashing.<br></br>-Enabled file-based key and message management to simulate real-world secure communication workflows.
            </td>
          </tr>

          <tr class ="td-typing-area">
            <td class="academic"><a class="project-header"><a href="https://github.com/Chegarty123/SEOpenCourtFinal.git" target="_blank" rel="noopener noreferrer">OpenCourt App | Full-Stack Developer | January 2024 - May 2024</a></a><br></br>-Collaborated with a team to develop a pickup basketball app compatible with Android and Web
          ...
          <tr>
            ...
            <td class="academic"><a class="project-header"><a href="https://github.com/tylerheckel2/MultiLevel2DPlatformerGame.git" target="_blank" rel="noopener noreferrer">Multi-level 2D Platformer Game | Lead Game Developer | Personal Project | August 2023</a></a><br></br>-Developed a dynamic and engaging multi-level 2D platformer game using Unity Game Engine and C#
          ...
          <tr>
          <td class ="academic"><a class="project-header"><a href="https://github.com/tylerheckel2/NBAStatsWebsiteProject.git" target="_blank" rel="noopener noreferrer">NBA Statistics Tracker Website | Full-Stack Developer | December 2023</a></a><br></br>-Developed an NBA Statistics Tracker website in collaboration with a team using React.<br></br>-Utilized the capabilities of React.js, HTML, and CSS to build a dynamic and responsive user interface,
    ...
    <h2>Other GitHub Links</h2>
        <div className = "projectlink-box">
        <p>
            <a href="https://github.com/tylerheckel2" target="_blank" rel="noopener noreferrer">GitHub Profile</a> | <a href="https://github.com/tylerheckel2/MyPortfolioWebsite" target="_blank" rel="noopener noreferrer">This Website</a>
        </p>
        </div>
      <footer>
